        ...
        function (t, e, a) {
          ...
          e.exports = function (t) {
            t.Radar = function (e, a) {
              return (
                (a.options = t.helpers.configMerge(
                  { aspectRatio: 1 },
                  a.options
                )),
                (a.type = "radar"),
            ...
            (t.defaults.bar = {
              ...
              (t.controllers.bar = t.DatasetController.extend({
                ...
                calculateBarX: function (t, e) {
                  ...
                  return (
                    (l -= a.chart.isCombo ? r.tickWidth / 2 : 0),
                    n.options.stacked
                      ? l + r.categoryWidth / 2 + r.categorySpacing
                      : l +
                        r.barWidth / 2 +
                        r.categorySpacing +
                        r.barWidth * o +
              ...
              (t.controllers.horizontalBar = t.controllers.bar.extend({
                ...
                calculateBarY: function (t, e) {
                  var a = this,
                    ...
                    l = n.getPixelForValue(null, t, e, a.chart.isCombo);
                  return (
                    (l -= a.chart.isCombo ? r.tickHeight / 2 : 0),
                    n.options.stacked
                      ? l + r.categoryHeight / 2 + r.categorySpacing
                      : l +
                        r.barHeight / 2 +
                        r.categorySpacing +
                        r.barHeight * o +
                ...
                t.DatasetController.extend({
                  ...
                  update: function (t) {
                    ...
                    if (f < 2 * Math.PI) {
                      ...
                      (d = Math.min(l / M.width, s / M.height)),
                        (u = { x: (C.x + w.x) * -0.5, y: (C.y + w.y) * -0.5 });
                    }
              ...
              (t.controllers.line = t.DatasetController.extend({
                ...
                addElementAndReset: function (a) {
                  var i = this,
                    n = i.chart.options,
                    o = i.getMeta();
                  t.DatasetController.prototype.addElementAndReset.call(i, a),
                    e(i.getDataset(), n) &&
                      0 !== o.dataset._model.tension &&
                ...
                updateBezierControlPoints: function () {
                  ...
                  for (e = 0, i = u.length; i > e; ++e)
                    (n = u[e]),
                      ...
                      (o.controlPointNextX = t(r.next.x, d.left, d.right)),
                      (o.controlPointNextY = t(r.next.y, d.top, d.bottom));
                },
                draw: function (t) {
                  var a,
                    i,
              ...
              e.extend(t.Controller.prototype, {
                ...
                resize: function (a) {
                  var i = this,
                    ...
                    l = n.aspectRatio,
                    s =
                      i.options.maintainAspectRatio &&
                      isNaN(l) === !1 &&
                      isFinite(l) &&
                      0 !== l
                        ? r / l
                        : e.getMaximumHeight(o),
                  ...
                  return (
                    t.plugins.notify("resize", [i, u]),
                    i.options.onResize && i.options.onResize(i, u),
                    a ||
                      (i.stop(),
                      i.update(i.options.responsiveAnimationDuration)),
                    i
                  );
                },
                  ...
                  if (
                    (e.each(
                      ...
                      function (e, o) {
                        ...
                        r.type || (r.type = e.type || a.config.type),
                          i.push(r.type),
                          r.controller
                            ? r.controller.updateIndex(o)
                            : ((r.controller = new t.controllers[r.type](a, o)),
                              n.push(r.controller));
                      },
                      a
                    ),
                ...
                update: function (a, i) {
                  var n = this;
                  t.plugins.notify("beforeUpdate", [n]),
                  ...
                  e.each(
                    ...
                    t.layoutService.update(n, n.chart.width, n.chart.height),
                    t.plugins.notify("afterScaleUpdate", [n]),
                    e.each(o, function (t) {
                      t.reset();
                    }),
                    n.updateDatasets(),
                    t.plugins.notify("afterUpdate", [n]),
                    n.render(a, i);
                },
                ...
                render: function (a, i) {
                  ...
                  if (
                    ...
                    (("undefined" != typeof a && 0 !== a) ||
                      ("undefined" == typeof a && 0 !== o.duration))
                  ) {
                    var r = new t.Animation();
                    (r.numSteps = (a || o.duration) / 16.66),
                      (r.easing = o.easing),
                      (r.render = function (t, a) {
                        var i = e.easingEffects[a.easing],
                          n = a.currentStep / a.numSteps,
                          o = i(n);
                        t.draw(o, n, a.currentStep);
                      }),
                      (r.onAnimationProgress = o.onProgress),
                      (r.onAnimationComplete = o.onComplete),
                      t.animationService.addAnimation(n, r, a, i);
                  } else
                    n.draw(),
                      o &&
                        o.onComplete &&
                ...
                draw: function (a) {
                  var i = this,
                    n = a || 1;
                  i.clear(),
                    t.plugins.notify("beforeDraw", [i, n]),
                    e.each(
                      i.boxes,
                      function (t) {
                        t.draw(i.chartArea);
                    ...
                    i.scale && i.scale.draw(),
                    t.plugins.notify("beforeDatasetsDraw", [i, n]),
                    e.each(
                      i.data.datasets,
                      function (t, e) {
                        i.isDatasetVisible(e) &&
                          i.getDatasetMeta(e).controller.draw(a);
                      },
                      i,
                      !0
                    ),
                    t.plugins.notify("afterDatasetsDraw", [i, n]),
                    i.tooltip.transition(n).draw(),
                    t.plugins.notify("afterDraw", [i, n]);
                },
                getElementAtEvent: function (t) {
                  var a = this,
                    ...
                    n = [];
                  return (
                    e.each(a.data.datasets, function (t, o) {
                    ...
                    o = function () {
                      if (a.data.datasets)
                        for (var t = 0; t < a.data.datasets.length; t++) {
                          ...
                          if (a.isDatasetVisible(t))
                            for (var n = 0; n < e.data.length; n++)
                              if (e.data[n].inLabelRange(i.x, i.y))
                                return e.data[n];
                        }
                    }.call(a);
                  return o
                ...
                destroy: function () {
                  ...
                  a.stop(),
                    a.clear(),
                    e.unbindEvents(a, a.events),
                    e.removeResizeListener(a.chart.canvas.parentNode);
                  var i = a.chart.canvas;
                  (i.width = a.chart.width),
                    (i.height = a.chart.height),
                    void 0 !== a.chart.originalDevicePixelRatio &&
                      a.chart.ctx.scale(
                        1 / a.chart.originalDevicePixelRatio,
                        1 / a.chart.originalDevicePixelRatio
                      ),
                    (i.style.width = a.chart.originalCanvasStyleWidth),
                    (i.style.height = a.chart.originalCanvasStyleHeight),
                    t.plugins.notify("destroy", [a]),
                ...
                eventHandler: function (t) {
                  ...
                  return (
                    ...
                    "mouseout" === t.type
                      ? ((a.active = []), (a.tooltipActive = []))
                      : ((a.active = a.getElementsAtEventForMode(t, o.mode)),
                        (a.tooltipActive = a.getElementsAtEventForMode(
                          t,
                          r.mode
                        ))),
                    o.onHover && o.onHover.call(a, a.active),
                    ("mouseup" === t.type || "click" === t.type) &&
                      (n.onClick && n.onClick.call(a, t, a.active),
                      a.legend &&
                        a.legend.handleEvent &&
                        a.legend.handleEvent(t)),
                    a.lastActive.length &&
                      a.updateHoverStyle(a.lastActive, o.mode, !1),
                    a.active.length &&
                      o.mode &&
                      a.updateHoverStyle(a.active, o.mode, !0),
                    (r.enabled || r.custom) &&
                      (i.initialize(),
                      (i._active = a.tooltipActive),
                      i.update(!0)),
                    i.pivot(),
                    a.animating ||
                      (e.arrayEquals(a.active, a.lastActive) &&
                        e.arrayEquals(a.tooltipActive, a.lastTooltipActive)) ||
                      (a.stop(),
                      (r.enabled || r.custom) && i.update(!0),
                      a.render(o.animationDuration, !0)),
              ...
              e.extend(t.DatasetController.prototype, {
                ...
                removeHoverStyle: function (t, a) {
                  ...
                  (l.backgroundColor = o.backgroundColor
                    ? o.backgroundColor
                    : r(i.backgroundColor, n, a.backgroundColor)),
                    (l.borderColor = o.borderColor
                      ? o.borderColor
                      : r(i.borderColor, n, a.borderColor)),
                    (l.borderWidth = o.borderWidth
                      ? o.borderWidth
                      : r(i.borderWidth, n, a.borderWidth));
                },
                setHoverStyle: function (t) {
                  var a = this.chart.data.datasets[t._datasetIndex],
                    i = t._index,
                  ...
                  (l.backgroundColor = n.hoverBackgroundColor
                    ? n.hoverBackgroundColor
                    : o(a.hoverBackgroundColor, i, r(l.backgroundColor))),
                    (l.borderColor = n.hoverBorderColor
                      ? n.hoverBorderColor
                      : o(a.hoverBorderColor, i, r(l.borderColor))),
                    (l.borderWidth = n.hoverBorderWidth
                      ? n.hoverBorderWidth
                      : o(a.hoverBorderWidth, i, l.borderWidth));
                },
              }),
          ...
          e.exports = function (t) {
            ...
            (o.requestAnimFrame = (function () {
              ...
              (o.getMaximumWidth = function (t) {
                var e = t.parentNode,
                  a =
                    parseInt(o.getStyle(e, "padding-left")) +
                    parseInt(o.getStyle(e, "padding-right")),
                  i = e.clientWidth - a,
              ...
              (o.getMaximumHeight = function (t) {
                var e = t.parentNode,
                  a =
                    parseInt(o.getStyle(e, "padding-top")) +
                    parseInt(o.getStyle(e, "padding-bottom")),
                  i = e.clientHeight - a,
              ...
              (o.addResizeListener = function (t, e) {
                ...
                (n.width = "100%"),
                  ...
                  ((a.contentWindow || a).onresize = function () {
                    e && e();
                  });
              }),
          ...
          e.exports = function () {
            var t = function (e, a) {
              var i = this,
                n = t.helpers;
              return (
                (i.config = a || { data: { datasets: [] } }),
                e.length && e[0].getContext && (e = e[0]),
                e.getContext && (e = e.getContext("2d")),
                (i.ctx = e),
                (i.canvas = e.canvas),
                (e.canvas.style.display = e.canvas.style.display || "block"),
                (i.width =
                  e.canvas.width ||
                  parseInt(n.getStyle(e.canvas, "width"), 10) ||
                  n.getMaximumWidth(e.canvas)),
                (i.height =
                  e.canvas.height ||
                  parseInt(n.getStyle(e.canvas, "height"), 10) ||
                  n.getMaximumHeight(e.canvas)),
                (i.aspectRatio = i.width / i.height),
                (isNaN(i.aspectRatio) || isFinite(i.aspectRatio) === !1) &&
                  (i.aspectRatio =
                    void 0 !== a.aspectRatio ? a.aspectRatio : 2),
                (i.originalCanvasStyleWidth = e.canvas.style.width),
                (i.originalCanvasStyleHeight = e.canvas.style.height),
                n.retinaScale(i),
                (i.controller = new t.Controller(i)),
                n.addResizeListener(e.canvas.parentNode, function () {
                  i.controller &&
              ...
              update: function (t, a, i) {
                function n(t) {
                  var e,
                    a = t.isHorizontal();
                  a
                    ? ((e = t.update(t.options.fullWidth ? p : k, y)),
                      (S -= e.height))
                    : ((e = t.update(x, v)), (k -= e.width)),
                    w.push({ horizontal: a, minSize: e, box: t });
                }
                function o(t) {
                ...
                function l(t) {
                  t.isHorizontal()
                    ? ((t.left = t.options.fullWidth ? s : C),
                      (t.right = t.options.fullWidth ? a - s : C + k),
                      (t.top = P),
                      (t.bottom = P + t.height),
                      (P = t.bottom))
                    : ((t.left = F),
          ...
          e.exports = function (t) {
            ...
            (t.defaults.global.legend = {
              ...
              labels: {
                ...
                generateLabels: function (t) {
                  var a = t.data;
                  return e.isArray(a.datasets)
                    ? a.datasets.map(function (a, i) {
                        return {
                          text: a.label,
                          fillStyle: e.isArray(a.backgroundColor)
                            ? a.backgroundColor[0]
                            : a.backgroundColor,
              ...
              (t.Legend = t.Element.extend({
                ...
                fit: function () {
                  ...
                  if (
                    (p
                      ? ((g.width = a.maxWidth), (g.height = o ? 10 : 0))
                      : ((g.width = o ? 10 : 0), (g.height = a.maxHeight)),
                    o)
                  )
                    if (((r.font = h), p)) {
                      ...
                      (r.textAlign = "left"),
                        ...
                        e.each(a.legendItems, function (t, e) {
                          var i = n.usePointStyle
                              ? d * Math.sqrt(2)
                              : n.boxWidth,
                            o = i + d / 2 + r.measureText(t.text).width;
                          m[m.length - 1] + o + n.padding >= a.width &&
                            ((b += d + n.padding), (m[m.length] = a.left)),
                            (f[e] = { left: 0, top: 0, width: o, height: d }),
                      ...
                      e.each(a.legendItems, function (t, e) {
                        ...
                        S + w > g.height &&
                          ((y += k + n.padding), x.push(k), (k = 0), (S = 0)),
                          (k = Math.max(k, i)),
                          (S += w),
                          (f[e] = { left: 0, top: 0, width: i, height: d });
                      }),
                        (y += k),
                        x.push(k),
                        (g.width += y);
                    ...
                    var b = n.boxWidth,
                      ...
                      x = function (e, a, n) {
                        if (!(isNaN(b) || 0 >= b)) {
                          if (
                            (u.save(),
                            (u.fillStyle = c(n.fillStyle, o.defaultColor)),
                            (u.lineCap = c(n.lineCap, r.borderCapStyle)),
                            (u.lineDashOffset = c(
                              n.lineDashOffset,
                              r.borderDashOffset
                            )),
                            (u.lineJoin = c(n.lineJoin, r.borderJoinStyle)),
                            (u.lineWidth = c(n.lineWidth, r.borderWidth)),
                            (u.strokeStyle = c(n.strokeStyle, o.defaultColor)),
                            u.setLineDash &&
                              u.setLineDash(c(n.lineDash, r.borderDash)),
                            i.labels && i.labels.usePointStyle)
                          ) {
                            ...
                            u.strokeRect(e, a, b, f), u.fillRect(e, a, b, f);
                          u.restore();
                        }
                      },
                      y = function (t, e, a, i) {
                        u.fillText(a.text, b + f / 2 + t, e),
                          a.hidden &&
                            (u.beginPath(),
                            (u.lineWidth = 2),
                            u.moveTo(b + f / 2 + t, e + f / 2),
                            u.lineTo(b + f / 2 + t + i, e + f / 2),
                            u.stroke());
                      },
                      k = a.isHorizontal();
                    d = k
                    ...
                    e.each(a.legendItems, function (t, e) {
                      ...
                      k
                        ? r + o >= l &&
                          ((c = d.y += S),
                          d.line++,
                          (r = d.x = a.left + (l - s[d.line]) / 2))
                        : c + S > a.bottom &&
                          ((r = d.x = r + a.columnWidths[d.line] + n.padding),
                          (c = d.y = a.top),
                          d.line++),
                        x(r, c, t),
                        (v[e].left = r),
              ...
              (t.Scale = t.Element.extend({
                ...
                convertTicksToLabels: function () {
                  ...
                  t.ticks = t.ticks.map(function (e, a, i) {
                    return t.options.ticks.userCallback
                      ? t.options.ticks.userCallback(e, a, i)
                      : t.options.ticks.callback(e, a, i);
                  }, t);
                },
                  ...
                  if (
                    (d
                      ? (i.width = a.isFullWidth()
                          ...
                          : a.maxWidth)
                      : (i.width = s ? p : 0),
                    d ? (i.height = s ? p : 0) : (i.height = a.maxHeight),
                    l.display &&
                      s &&
                      (d ? (i.height += 1.5 * g) : (i.width += 1.5 * g)),
                    r.display && s)
                  ) {
                    a.longestTextCache || (a.longestTextCache = {});
                    var m = e.longestText(
                    ...
                    if (d) {
                      ...
                      var x =
                        ...
                        u * b +
                        v * b;
                      (i.height = Math.min(a.maxHeight, i.height + x)),
                        (a.ctx.font = f);
                      ...
                      (a.paddingLeft =
                        0 !== a.labelRotation ? S * y + 3 : y / 2 + 3),
                        (a.paddingRight =
                          0 !== a.labelRotation ? w * (u / 2) + 3 : k / 2 + 3);
                    } else {
                      var C = a.maxWidth - i.width,
                        M = r.mirror;
                      M ? (m = 0) : (m += a.options.ticks.padding),
                        C > m ? (i.width += m) : (i.width = a.maxWidth),
                        (a.paddingTop = u / 2),
                        (a.paddingBottom = u / 2);
                    }
                  }
                  ...
                  if (n.display) {
                    ...
                    if (g) {
                      if (
                        ((o = !1),
                        h && (I /= 2),
                        (I + d.autoSkipPadding) * i.ticks.length >
                    ...
                    if (
                        ...
                        if (void 0 !== t && null !== t) {
                          ...
                          if ((!s || l) && void 0 !== t && null !== t) {
                            ...
                            if (g) {
                              ...
                              "left" === n.position
                                ? d.mirror
                                  ? ((C = i.right + d.padding), (A = "left"))
                                  : ((C = i.right - d.padding), (A = "right"))
                                : d.mirror
                                ? ((C = i.left - d.padding), (A = "right"))
                                : ((C = i.left + d.padding), (A = "left"));
                              var L = i.getPixelForTick(r);
                              (L += e.aliasPixel(c)),
                                (M = i.getPixelForTick(r, u.offsetGridLines)),
                                (p = F),
                                (b = P),
                                (x = a.left),
                                (S = a.right),
                      ...
                      if (g)
                        ...
                        (V = B ? i.left + S / 2 : i.right - S / 2),
                          (L = i.top + (i.bottom - i.top) / 2),
                          (O = B ? -0.5 * Math.PI : 0.5 * Math.PI);
                      }
                      l.save(),
                        l.translate(V, L),
                        l.rotate(O),
                    ...
                    if (u.drawBorder) {
                      ...
                      g
                        ? ((N = H = "top" === n.position ? i.bottom : i.top),
                          (N += E),
                          (H += E))
                        : ((W = z = "left" === n.position ? i.right : i.left),
                          (W += E),
                          (z += E)),
                        l.beginPath(),
                        l.moveTo(W, N),
              ...
              draw: function () {
                ...
                if (o.display) {
                  ...
                  (i.fillStyle = n(o.fontColor, r.defaultFontColor)),
                    ...
                    a.isHorizontal()
                      ? ((l = p + (b - p) / 2), (s = g + (m - g) / 2))
                      : ((l = "left" === o.position ? p + d / 2 : b - d / 2),
                        (s = g + (m - g) / 2),
                        (f = Math.PI * ("left" === o.position ? -0.5 : 0.5))),
                    i.save(),
                    i.translate(l, s),
                    i.rotate(f),
                    (i.textAlign = "center"),
                    (i.textBaseline = "middle"),
                    i.fillText(o.text, 0, 0),
                    i.restore();
                }
              },
            })),
        ...
        function (t, e, a) {
          ...
          e.exports = function (t) {
            function e(t, e) {
              return (
                e &&
                  (n.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
                t
              );
            }
            function a(t) {
              ...
              (t.Tooltip = t.Element.extend({
                ...
                getBody: function (t, a) {
                  ...
                  return (
                    n.each(t, function (t) {
                      ...
                      e(n.before, o.beforeLabel.call(i, t, a)),
                        e(n.lines, o.label.call(i, t, a)),
                        e(n.after, o.afterLabel.call(i, t, a)),
                        r.push(n);
                    }),
                    r
                  );
                ...
                update: function (t) {
                  ...
                  if (d.length) {
                    ...
                    l.itemSort && (g = g.sort(l.itemSort)),
                      d.length > 1 &&
                        n.each(g, function (t) {
                    ...
                    r.determineAlignment(p),
                      n.extend(s, r.getBackgroundPoint(s, p));
                ...
                getTooltipSize: function (t) {
                  ...
                  var r = t.title.length,
                    ...
                    u = t.footerFontSize;
                  (a.height += r * s),
                    (a.height += (r - 1) * t.titleSpacing),
                    (a.height += r ? t.titleMarginBottom : 0),
                    (a.height += o * d),
                    (a.height += o ? (o - 1) * t.bodySpacing : 0),
                    (a.height += l ? t.footerMarginTop : 0),
                    (a.height += l * u),
                    (a.height += l ? (l - 1) * t.footerSpacing : 0);
                  var c = 0,
                    h = function (t) {
                  ...
                  return (
                    ...
                    n.each(t.beforeBody.concat(t.afterBody), h),
                    (c = i.length > 1 ? d + 2 : 0),
                    n.each(i, function (t) {
                      n.each(t.before, h),
                        n.each(t.lines, h),
                ...
                determineAlignment: function (t) {
                  ...
                  a.y < t.height
                    ? (a.yAlign = "top")
                    : a.y > i.height - t.height && (a.yAlign = "bottom");
                  var o,
                    r,
                    l,
                    s,
                  ...
                  "center" === a.yAlign
                    ...
                    o(a.x)
                      ? ((a.xAlign = "left"),
                        l(a.x) && ((a.xAlign = "center"), (a.yAlign = d(a.y))))
                      : r(a.x) &&
                        ((a.xAlign = "right"),
                        s(a.x) && ((a.xAlign = "center"), (a.yAlign = d(a.y))));
                },
                ...
                drawCaret: function (t, e, a) {
                  ...
                  (c.fillStyle = y.alpha(a * y.alpha()).rgbString()),
                    c.beginPath(),
                    c.moveTo(i, l),
                    c.lineTo(o, s),
                    c.lineTo(r, d),
                ...
                drawTitle: function (t, e, a, i) {
                  ...
                  if (o.length) {
                    ...
                    (a.fillStyle = s.alpha(i * s.alpha()).rgbString()),
                      (a.font = n.fontString(
                        r,
                        e._titleFontStyle,
                        e._titleFontFamily
                    ...
                    for (d = 0, u = o.length; u > d; ++d)
                      a.fillText(o[d], t.x, t.y),
                        (t.y += r + l),
                        d + 1 === o.length && (t.y += e.titleMarginBottom - l);
                  }
                },
                      ...
                      n.each(r.before, c),
                        n.each(r.lines, function (r) {
                          h &&
                            ...
                            (a.strokeStyle = n
                              .color(e.labelColors[l].borderColor)
                              .alpha(i)
                              .rgbaString()),
                            a.strokeRect(t.x, t.y, o, o),
                            (a.fillStyle = n
                              .color(e.labelColors[l].backgroundColor)
                              .alpha(i)
                              .rgbaString()),
                ...
                drawFooter: function (t, e, a, i) {
                  ...
                  if (o.length) {
                    ...
                    (a.fillStyle = r.alpha(i * r.alpha()).rgbString()),
                      (a.font = n.fontString(
                        e.footerFontSize,
                        e._footerFontStyle,
                        e._footerFontFamily
                ...
                draw: function () {
                  ...
                  if (0 !== e.opacity) {
                    ...
                    if (this._options.enabled) {
                      ...
                      (t.fillStyle = r.alpha(o * r.alpha()).rgbString()),
                        n.drawRoundedRectangle(
                          t,
                          i.x,
                          i.y,
                          a.width,
                        ...
                        t.fill(),
                        this.drawCaret(i, a, o),
                        (i.x += e.xPadding),
                        (i.y += e.yPadding),
                        this.drawTitle(i, e, t, o),
                        this.drawBody(i, e, t, o),
                        this.drawFooter(i, e, t, o);
                    }
                  }
                },
              }));
                ...
                draw: function () {
                  function t(t, e) {
                    ...
                    e._view.steppedLine === !0
                      ? (s.lineTo(e._view.x, t._view.y),
                        s.lineTo(e._view.x, e._view.y))
                      : 0 === e._view.tension
                      ? s.lineTo(a.x, a.y)
                      : s.bezierCurveTo(
              ...
              (t.elements.Point = t.Element.extend({
                ...
                draw: function () {
                  var n = this._view,
                    ...
                    d = n.y;
                  n.skip ||
                    ((o.strokeStyle = n.borderColor || i),
                    (o.lineWidth = e.getValueOrDefault(
                      n.borderWidth,
                      a.elements.point.borderWidth
                    )),
                    (o.fillStyle = n.backgroundColor || i),
                    t.canvasHelpers.drawPoint(o, r, l, s, d));
                },
              }));
          };
        },
              ...
              i = t.Scale.extend({
                ...
                getPixelForValue: function (t, e, a, i) {
                  ...
                  if (n.isHorizontal()) {
                    ...
                    return (
                      n.options.gridLines.offsetGridLines && i && (u += d / 2),
                      n.left + Math.round(u)
                    );
                  }
          ...
          e.exports = function (t) {
            ...
            t.LinearScaleBase = t.Scale.extend({
              ...
              buildTicks: function () {
                ...
                var l,
                  s =
                    (n.fixedStepSize && n.fixedStepSize > 0) ||
                ...
                var u = Math.floor(t.min / l) * l,
                  ...
                  h = (c - u) / l;
                (h = e.almostEquals(h, Math.round(h), l / 1e3)
                  ? Math.round(h)
                  : Math.ceil(h)),
                  i.push(void 0 !== n.min ? n.min : u);
                for (var f = 1; h > f; ++f) i.push(u + f * l);
                i.push(void 0 !== n.max ? n.max : c),
                ...
                buildTicks: function () {
                  for (
                    var t = this,
                      ...
                      n = e.getValueOrDefault,
                      o = (t.ticks = []),
                      r = n(i.min, Math.pow(10, Math.floor(e.log10(t.min))));
                    r < t.max;
                ...
                getPixelForValue: function (t) {
                  ...
                  return (
                    n.isHorizontal()
                      ? 0 === r
                        ? (i = n.left + u)
                        : ((a = n.width - (u + n.paddingRight)),
                          (i = n.left + (a / l) * (e.log10(r) - e.log10(o))),
                          (i += u))
                      : 0 === r
                      ? (i = n.top + s)
                      : ((a = n.height - (s + d)),
                        (i =
                          n.bottom - d - (a / l) * (e.log10(r) - e.log10(o)))),
                    i
                  );
                },
                getValueForPixel: function (t) {
              ...
              var e = t.helpers,
                ...
                o = t.Scale.extend({
                  ...
                  getLabelMoment: function (t, e) {
                    return "undefined" != typeof this.labelMoments[t]
                  ...
                  buildTicks: function () {
                    ...
                    (i.smallestLabelSeparation = i.width),
                      e.each(
                        i.chart.data.datasets,
                        function (t, e) {
                          for (var a = 1; a < i.labelMoments[e].length; a++)
                            i.smallestLabelSeparation = Math.min(
                              i.smallestLabelSeparation,
                              i.labelMoments[e][a].diff(
                                i.labelMoments[e][a - 1],
                                i.tickUnit,
                                !0
                              )
                            );
                    ...
                    var C = i.ticks[i.ticks.length - 1].diff(
                      i.lastTick,
                      i.tickUnit
                    );
                    (0 !== C || 0 === i.scaleSizeInUnits) &&
                      (i.options.time.max
